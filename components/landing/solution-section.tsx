      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <ScrollAnimation animation="fadeInLeft" delay={100}>
            <div className="relative group mt-6 sm:mt-0">
              <div className="absolute -top-4 -left-2 sm:-top-6 sm:-left-6 w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-[#0F172A] text-white flex items-center justify-center font-black text-xl sm:text-2xl z-10 border-4 border-white shadow-lg">
                1
              </div>
              <div className="p-6 sm:p-10 rounded-lg border-2 border-[#0F172A] bg-white h-full pt-12 sm:pt-16 hover:shadow-2xl transition-all hover:-translate-y-2">
          ...
          <ScrollAnimation animation="fadeInUp" delay={200}>
            <div className="relative group mt-6 sm:mt-0">
              <div className="absolute -top-4 -left-2 sm:-top-6 sm:-left-6 w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-[#16A34A] text-white flex items-center justify-center font-black text-xl sm:text-2xl z-10 border-4 border-white shadow-lg animate-float">
                2
              </div>
              <div className="p-6 sm:p-10 rounded-lg border-2 border-[#16A34A] bg-white h-full pt-12 sm:pt-16 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                <div className="flex justify-center mb-8">
          ...
          <ScrollAnimation animation="fadeInRight" delay={300}>
            <div className="relative group mt-6 sm:mt-0">
              <div className="absolute -top-4 -left-2 sm:-top-6 sm:-left-6 w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-[#2563EB] text-white flex items-center justify-center font-black text-xl sm:text-2xl z-10 border-4 border-white shadow-lg animate-float" style={{ animationDelay: "0.5s" }}>
                3
              </div>
              <div className="p-6 sm:p-10 rounded-lg border-2 border-[#2563EB] bg-white h-full pt-12 sm:pt-16 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                <div className="flex justify-center mb-8">
