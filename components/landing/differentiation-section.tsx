      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <ScrollAnimation animation="fadeInLeft" delay={100}>
            <div className="p-10 rounded-lg border-2 border-[#2563EB] bg-[#0F172A] hover:bg-[#2563EB]/10 transition-all duration-300 group hover:scale-105 hover:shadow-xl">
          ...
          <ScrollAnimation animation="fadeInRight" delay={200}>
            <div className="p-10 rounded-lg border-2 border-[#16A34A] bg-[#0F172A] hover:bg-[#16A34A]/10 transition-all duration-300 group hover:scale-105 hover:shadow-xl">
            <div className="flex items-center gap-4 mb-8">
