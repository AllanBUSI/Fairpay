  ...
  return (
    <section className="relative py-32 px-4 sm:px-6 lg:px-8 bg-white overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        {/* Comparaison avec les concurrents - Masquée sur mobile */}
        {/* Comparaison avec les concurrents */}
        <ScrollAnimation animation="scaleIn" delay={100}>
          <div className="mb-16 p-6 sm:p-8 rounded-lg bg-[#2563EB]/10 border-2 border-[#2563EB] hover:shadow-xl transition-all duration-300">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <AlertTriangle className="h-8 w-8 text-[#2563EB] flex-shrink-0 mt-1" />
              <div>
                <h3 className="text-xl sm:text-2xl font-black text-[#0F172A] mb-3 tracking-tight">
                  Attention : Les recommandés sans lettre d'avocat n'ont pas de valeur légale
                </h3>
                <p className="text-[#0F172A] text-base sm:text-lg leading-relaxed font-light">
        ...
        <ScrollAnimation animation="fadeInUp" delay={200}>
          <div className="mb-16 overflow-x-auto">
            <table className="w-full min-w-[800px] border-collapse border-2 border-[#0F172A]">
              <thead>
